...
class Sky:
    def __init__(self, horizon):
        ...
        self.middle = pygame.image.load(
            './gui/graphics/decoration/sky/sky_middle.png').convert()
        self.bottom = pygame.image.load(
            './gui/graphics/decoration/sky/sky_bottom.png').convert()
...
class Water:
    def __init__(self, top, level_width):
        ...
        for tile in range(tile_x_amount):
            ...
            y = top
            sprite = AnimatedTile(water_tile_width, x, y,
                                  './gui/graphics/decoration/water')
...
class Clouds:
    def __init__(self, horizon, level_width, cloud_number):
        cloud_surf_list = import_folder('./gui/graphics/decoration/clouds')
        min_x = -screen_width
